...
<body>
    ...
    <nav class="navbar" id="navbar">
        ...
        <ul class="nav-items">
        <li><a href="main.html" class="nav-link"><i class="fa fa-columns" aria-hidden="true"></i> Dashboard</a></li>
            <li><a href="songs.html" class="nav-link"><i class="fa fa-headphones" aria-hidden="true"></i> Audio Playlist</a></li>
            <li><a href="#" class="nav-link"><i class="fa fa-play-circle-o" aria-hidden="true"></i> Reels</a></li>
            <li><a href="online.htlm" class="nav-link"><i class="fa fa-laptop" aria-hidden="true"></i> Tutorials</a></li>
            <li><a href="we.html" class="nav-link"><i class="fa fa-address-card" aria-hidden="true"></i>
 About Us</a></li>
            <li><a href="customer.html" class="nav-link"><i class="fa fa-star" aria-hidden="true"></i>
    ...
    <section class="services">
        ...
        <div class="section-center clearfix">
            ...
            <article class="service-card">
                ...
                <div class="service-img-container">
                    <!-- igm -->
                    <video src="vedios/music2.mp4" height="300px" width="290px" poster="/images/green.jpeg" controls></video>                   
                    <!-- service icon -->
                    <span class="service-icon">
            ...
            <article class="service-card">
                ...
                <div class="service-img-container">
                    <!-- igm -->
                    <video src="vedios/music3.mp4" height="300px" width="290px"poster="https://wallpaperaccess.com/full/1162634.jpg" controls></video>                   
                    <!-- service icon -->
                    <span class="service-icon">
                        <i class="fa fa-music" aria-hidden="true"></i>
                    </span>
